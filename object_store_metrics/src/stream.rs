...
impl BytesStreamDelegate {
    pub(crate) fn new(recorder: MetricsWithBytesAndTtfbRecorder) -> Self {
        Self {
            recorder,
            first_byte: None,
            sum_bytes: 0,
...
impl MetricDelegate for BytesStreamDelegate {
    ...
    fn finish(&mut self, op_res: OpResult) {
        ...
        self.recorder
            .submit(Some(first_byte), op_res, Some(self.sum_bytes as u64));
    }
}
...
mod tests {
    ...
    use crate::{
        MetricsWithBytesAndTtfb, StoreType,
        test_utils::{
    ...
    async fn test_stream_decorator() {
        ...
        let mut stream = StreamMetricRecorder::new(inner, BytesStreamDelegate::new(recorder));
    ...
    async fn test_stream_immediate_drop() {
        ...
        let stream = StreamMetricRecorder::new(inner, BytesStreamDelegate::new(recorder));
