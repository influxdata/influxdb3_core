...
decorate! {
    ...
    },
    {
        ...
        methods = [
            ...
            namespace_list_storage = list_storage(&mut self, sorting: Option<NamespaceSorting>, pagination: Option<PaginationOptions>) -> Result<Paginated<NamespaceWithStorage>>;
    ...
    },
    {
        ...
        methods = [
            ...
            table_list_storage_by_namespace_id = list_storage_by_namespace_id(&mut self, namespace_id: NamespaceId, sorting: Option<TableSorting>, pagination: Option<PaginationOptions>) -> Result<Paginated<TableWithStorage>>;
    ...
    },
    {
        ...
        methods = [
            ...
            parquet_delete_old_ids_count = delete_old_ids_count(&mut self, older_than: Timestamp, limit: u32) -> Result<u64>;
            ...
            parquet_exists_by_partition_object_store_id_batch = exists_by_partition_and_object_store_id_batch(&mut self, ids: Vec<(PartitionId, ObjectStoreId)>) -> Result<Vec<(PartitionId, ObjectStoreId)>>;
            ...
            parquet_list_files_by_namespace_id = list_by_namespace_id(&mut self, namespace_id: NamespaceId, deleted: SoftDeletedRows) -> Result<Vec<ParquetFile>>;
        ],
    },
}
