        ...
        paste! {
            ...
            pub struct [<Tokio $name:camel Config>] {
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_TYPE"),
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_DISABLE_LIFO_SLOT"),
                    action
                )]
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_EVENT_INTERVAL"),
                    action
                )]
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_GLOBAL_QUEUE_INTERVAL"),
                    action
                )]
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_MAX_BLOCKING_THREADS"),
                    action
                )]
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_MAX_IO_EVENTS_PER_TICK"),
                    action
                )]
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_THREAD_KEEP_ALIVE"),
                ...
                #[clap(
                    ...
                    env = concat!("INFLUXDB_IOX_", stringify!([<$name:upper>]), "_RUNTIME_THREAD_PRIORITY"),
            ...
            impl [<Tokio $name:camel Config>] {
                ...
                pub fn builder_with_name(&self, name: &str) -> Result<::tokio::runtime::Builder, std::io::Error> {
                    ...
                    builder.thread_name_fn(move || {
                        format!("IOx Tokio {} {}", name, thread_counter.fetch_add(1, Ordering::SeqCst))
                    });
    ...
    fn test_thread_name() {
        assert_runtime_thread_property(
            TokioIoConfig::parse_from(std::iter::empty::<OsString>())
                ...
                .unwrap(),
            || {
                assert_thread_name("IOx Tokio IO");
            },
        );
        assert_runtime_thread_property(
            TokioDatafusionConfig::parse_from(std::iter::empty::<OsString>())
                ...
                .unwrap(),
            || {
                assert_thread_name("IOx Tokio Datafusion");
            },
        );
        assert_runtime_thread_property(
            TokioDatafusionConfig::parse_from(std::iter::empty::<OsString>())
                ...
                .unwrap(),
            || {
                assert_thread_name("IOx Tokio foo");
            },
        );
    }
