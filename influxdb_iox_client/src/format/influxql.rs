...
mod test {
    ...
    fn test_write_columnar() {
        ...
        +----------------------+------+--------+------------+------+
        | 2006-09-01T03:45:00Z | cpu0 |        | 99.1       |      |
        | 2006-09-01T03:45:10Z | cpu0 |        | 99.8       |      |
        | 2006-09-01T03:45:00Z | cpu1 |        | 99.2       |      |
        +----------------------+------+--------+------------+------+
        name: disk
        +----------------------+-----+---------+------------+------+
        | time                 | cpu | device  | usage_idle | free |
        +----------------------+-----+---------+------------+------+
        | 2006-09-01T03:45:00Z |     | disk1s1 |            | 2133 |
        | 2006-09-01T03:45:00Z |     | disk1s2 |            | 4110 |
        +----------------------+-----+---------+------------+------+
        "###);
        ...
        +----------------------+--------+------------+------+
        | 2006-09-01T03:45:00Z |        | 99.1       |      |
        | 2006-09-01T03:45:10Z |        | 99.8       |      |
        +----------------------+--------+------------+------+
        name: cpu
        tags: cpu=cpu1
        +----------------------+--------+------------+------+
